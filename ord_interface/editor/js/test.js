...
(async () => {
  ...
  page.goto('http://localhost:8080/editor/authenticate');
  await page.waitForNavigation();

  // Round-trip these reactions through the DOM and compare at the server.
  const roundtripTests = [
    'http://localhost:8080/editor/dataset/empty/reaction/0',
    'http://localhost:8080/editor/dataset/full/reaction/0',
