...
export default {
  ...
  methods: {
    ...
    submitUpload() {
      if (this.uploadFile.loading) return alert('Files are still processing. Please try again in a moment.');
      else if (!this.uploadFile.value) return alert('You must upload a file for the dataset before submitting.');
