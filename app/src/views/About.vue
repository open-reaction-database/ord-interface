      ...
      <div class="col-9 p-3">
        ...
        <ul>
          ...
          <li>
            ...
            <a href="https://en.wikipedia.org/wiki/FAIR_data">FAIR</a> data structure for sharing reaction data across
      ...
      <div class="col-9 p-3">
        ...
        <ul>
          <li>
            ...
            Reaction Database. <em>J Am Chem Soc</em> 2021, 143(45), 18820-18826. (<a
          ...
          <li>
            ...
            Structured Reaction Data. <em>J Chem Inf Model</em> 2023, 63(14), 4253-4265. (<a
        ...
        <ul>
          <li>
            A new database for machine-learning research (<a
              href="https://cen.acs.org/physical-chemistry/computational-chemistry/new-database-machine-learning-research/99/web/2021/11"
              >C&EN</a
            >, 22 November 2021)
          </li>
          <li>
            Yield-predicting AI needs chemists to stop ignoring failed experiments (<a
              href="https://www.chemistryworld.com/news/yield-predicting-ai-needs-chemists-to-stop-ignoring-failed-experiments/4015662.article"
              >Chemistry World</a
            >, 12 May 2022)
          </li>
          <li>
          ...
          <li>
            For chemists, the AI revolution has yet to happen (<a
              href="https://www.nature.com/articles/d41586-023-01612-x"
              >Nature</a
            >, 17 May 2023)
          </li>
        </ul>
